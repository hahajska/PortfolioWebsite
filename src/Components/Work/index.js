  ...
  return (
    <section className="lg:container lg:mx-auto">
      <div className="grid grid-cols-1">
        <div className="nadpisWork  justify-center py-8  text-center lg:text-right lg:flex lg:items-center lg:justify-end lg:py-12">
          <h1 className="lg:pr-24">My Projects</h1>
        </div>
      </div>
      <WorkItem />
      <WorkItem />
